...
public class InternetConnecter{
    ...
    */
    private InternetConnecter(){
        final String iconnectName = "Octo Robot Internet Connector";
        SmartDashboard.putString(iconnectName,  "Trying to establish connection");
        int trycount = 0;
        isConnected = false;
        outpipe = "\n";
        inpipe = "\n";
        while (trycount <= 3 && !isConnected){
            SmartDashboard.putString(iconnectName,  "Connection Attempt: " + String.valueOf( trycount ));
            try {
        ...
        SmartDashboard.putString(iconnectName,  isConnected ? "Connected" : "Connection Failed" );
    }
    ...
    */
    public void addToOutPipe(String data){
        // SmartDashboard.putString("Octo Robot Internet last sent",  data );
